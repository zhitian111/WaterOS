#![no_std]
//! Futex API v0：队列键、错误契约、内核 futex 表 trait 与 robust 链表布局占位。
//!
...
pub use key::FutexKey;
pub use ops::KernelFutexOps;
pub use robust::{RobustListHead, ROBUST_LIST_HEAD_SIZE};
