...
pub mod console {
    ...
    #[inline]
    #[allow(unused)]
    fn firmware_console_write_a_byte<Api: FirmwareConsole>(byte: u8) -> FirmwareConsoleResult<()> {
        Api::firmware_console_write_a_byte(byte)
    }
    #[inline]
    #[allow(unused)]
    fn firmware_console_write_a_buffer<Api: FirmwareConsole>(
        bytes: &[u8],
...
pub mod timer {
    ...
    #[inline]
    #[allow(unused)]
    fn firmware_set_timer<Api: FirmwareTimer>(
        time: FirmwareTimerDeadline,
    ) -> FirmwareTimerResult<()> {
...
pub mod reset {
    ...
    #[inline]
    #[allow(unused)]
    fn firmware_reset<Api: FirmwareReset>(
    ...
    #[inline]
    #[allow(unused)]
    fn firmware_reboot<Api: FirmwareReset>(
        reset_reason: FirmwareResetReason,
    ) -> FirmwareResetResult<()> {
    ...
    #[inline]
    #[allow(unused)]
    fn firmware_shutdown<Api: FirmwareReset>(
        reset_reason: FirmwareResetReason,
    ) -> FirmwareResetResult<()> {
