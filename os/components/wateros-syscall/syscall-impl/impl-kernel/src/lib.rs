...
#[inline]
pub fn is_restartable_syscall(syscall_nr : usize) -> bool { is_restartable_syscall_nr(syscall_nr) }
...
impl api_v0::SyscallDispatcher for KernelSyscallDispatcher {
    ...
    #[inline]
    fn dispatch_sched_setparam(args : SyscallArgs) -> isize { sys::sys_sched_setparam(args).0 }
    ...
    #[inline]
    fn dispatch_sched_getparam(args : SyscallArgs) -> isize { sys::sys_sched_getparam(args).0 }
    ...
    #[inline]
    fn dispatch_clone3(args : SyscallArgs) -> isize { sys::sys_clone3(args).0 }
    ...
    #[inline]
    fn dispatch_readv(args : SyscallArgs) -> isize { sys::sys_readv(args).0 }
    ...
    #[inline]
    fn dispatch_pread64(args : SyscallArgs) -> isize { sys::sys_pread64(args).0 }

    #[inline]
    fn dispatch_pwrite64(args : SyscallArgs) -> isize { sys::sys_pwrite64(args).0 }

    #[inline]
    fn dispatch_preadv(args : SyscallArgs) -> isize { sys::sys_preadv(args).0 }

    #[inline]
    fn dispatch_pwritev(args : SyscallArgs) -> isize { sys::sys_pwritev(args).0 }

    #[inline]
    fn dispatch_sendfile(args : SyscallArgs) -> isize { sys::sys_sendfile(args).0 }

    #[inline]
    fn dispatch_readlinkat(args : SyscallArgs) -> isize { sys::sys_readlinkat(args).0 }

    #[inline]
    fn dispatch_faccessat(args : SyscallArgs) -> isize { sys::sys_faccessat(args).0 }

    #[inline]
    fn dispatch_fchmod(args : SyscallArgs) -> isize { sys::sys_fchmod(args).0 }

    #[inline]
    fn dispatch_fchmodat(args : SyscallArgs) -> isize { sys::sys_fchmodat(args).0 }

    #[inline]
    fn dispatch_fchown(args : SyscallArgs) -> isize { sys::sys_fchown(args).0 }

    #[inline]
    fn dispatch_fchownat(args : SyscallArgs) -> isize { sys::sys_fchownat(args).0 }

    #[inline]
    fn dispatch_statfs(args : SyscallArgs) -> isize { sys::sys_statfs(args).0 }

    #[inline]
    fn dispatch_sync(args : SyscallArgs) -> isize { sys::sys_sync(args).0 }

    #[inline]
    fn dispatch_fsync(args : SyscallArgs) -> isize { sys::sys_fsync(args).0 }

    #[inline]
    fn dispatch_fdatasync(args : SyscallArgs) -> isize { sys::sys_fdatasync(args).0 }

    #[inline]
    fn dispatch_ftruncate(args : SyscallArgs) -> isize { sys::sys_ftruncate(args).0 }

    #[inline]
    fn dispatch_truncate(args : SyscallArgs) -> isize { sys::sys_truncate(args).0 }

    #[inline]
    fn dispatch_fallocate(args : SyscallArgs) -> isize { sys::sys_fallocate(args).0 }

    #[inline]
    fn dispatch_openat(args : SyscallArgs) -> isize { sys::sys_openat(args).0 }

    #[inline]
    fn dispatch_setxattr(args : SyscallArgs) -> isize { sys::sys_setxattr(args).0 }

    #[inline]
    fn dispatch_lsetxattr(args : SyscallArgs) -> isize { sys::sys_lsetxattr(args).0 }

    #[inline]
    fn dispatch_fsetxattr(args : SyscallArgs) -> isize { sys::sys_fsetxattr(args).0 }

    #[inline]
    fn dispatch_getxattr(args : SyscallArgs) -> isize { sys::sys_getxattr(args).0 }

    #[inline]
    fn dispatch_lgetxattr(args : SyscallArgs) -> isize { sys::sys_lgetxattr(args).0 }

    #[inline]
    fn dispatch_fgetxattr(args : SyscallArgs) -> isize { sys::sys_fgetxattr(args).0 }

    #[inline]
    fn dispatch_listxattr(args : SyscallArgs) -> isize { sys::sys_listxattr(args).0 }

    #[inline]
    fn dispatch_llistxattr(args : SyscallArgs) -> isize { sys::sys_llistxattr(args).0 }

    #[inline]
    fn dispatch_flistxattr(args : SyscallArgs) -> isize { sys::sys_flistxattr(args).0 }

    #[inline]
    fn dispatch_removexattr(args : SyscallArgs) -> isize { sys::sys_removexattr(args).0 }

    #[inline]
    fn dispatch_lremovexattr(args : SyscallArgs) -> isize { sys::sys_lremovexattr(args).0 }

    #[inline]
    fn dispatch_fremovexattr(args : SyscallArgs) -> isize { sys::sys_fremovexattr(args).0 }
    ...
    #[inline]
    fn dispatch_msync(args : SyscallArgs) -> isize { sys::sys_msync(args).0 }

    #[inline]
    fn dispatch_mprotect(args : SyscallArgs) -> isize { sys::sys_mprotect(args).0 }

    #[inline]
    fn dispatch_mremap(args : SyscallArgs) -> isize { sys::sys_mremap(args).0 }

    #[inline]
    fn dispatch_madvise(args : SyscallArgs) -> isize { sys::sys_madvise(args).0 }

    #[inline]
    fn dispatch_mlock(args : SyscallArgs) -> isize { sys::sys_mlock(args).0 }

    #[inline]
    fn dispatch_munlock(args : SyscallArgs) -> isize { sys::sys_munlock(args).0 }

    #[inline]
    fn dispatch_mlockall(args : SyscallArgs) -> isize { sys::sys_mlockall(args).0 }

    #[inline]
    fn dispatch_munlockall(args : SyscallArgs) -> isize { sys::sys_munlockall(args).0 }

    #[inline]
    fn dispatch_getmempolicy(args : SyscallArgs) -> isize { sys::sys_get_mempolicy(args).0 }

    #[inline]
    fn dispatch_shmget(args : SyscallArgs) -> isize { sys::sys_shmget(args).0 }

    #[inline]
    fn dispatch_shmctl(args : SyscallArgs) -> isize { sys::sys_shmctl(args).0 }

    #[inline]
    fn dispatch_shmat(args : SyscallArgs) -> isize { sys::sys_shmat(args).0 }

    #[inline]
    fn dispatch_shmdt(args : SyscallArgs) -> isize { sys::sys_shmdt(args).0 }
    ...
    #[inline]
    fn dispatch_clock_settime(args : SyscallArgs) -> isize { sys::sys_clock_settime(args).0 }

    #[inline]
    fn dispatch_clock_getres(args : SyscallArgs) -> isize { sys::sys_clock_getres(args).0 }

    #[inline]
    fn dispatch_clock_nanosleep(args : SyscallArgs) -> isize { sys::sys_clock_nanosleep(args).0 }
    ...
    #[inline]
    fn dispatch_setsid(_args : SyscallArgs) -> isize { sys::sys_setsid().0 }

    #[inline]
    fn dispatch_getgroups(args : SyscallArgs) -> isize { sys::sys_getgroups(args).0 }

    #[inline]
    fn dispatch_sysinfo(args : SyscallArgs) -> isize { sys::sys_sysinfo(args).0 }

    #[inline]
    fn dispatch_setuid(args : SyscallArgs) -> isize { sys::sys_setuid(args).0 }

    #[inline]
    fn dispatch_setgid(args : SyscallArgs) -> isize { sys::sys_setgid(args).0 }

    #[inline]
    fn dispatch_setreuid(args : SyscallArgs) -> isize { sys::sys_setreuid(args).0 }

    #[inline]
    fn dispatch_setregid(args : SyscallArgs) -> isize { sys::sys_setregid(args).0 }

    #[inline]
    fn dispatch_setresuid(args : SyscallArgs) -> isize { sys::sys_setresuid(args).0 }

    #[inline]
    fn dispatch_setresgid(args : SyscallArgs) -> isize { sys::sys_setresgid(args).0 }

    #[inline]
    fn dispatch_getresuid(args : SyscallArgs) -> isize { sys::sys_getresuid(args).0 }

    #[inline]
    fn dispatch_getresgid(args : SyscallArgs) -> isize { sys::sys_getresgid(args).0 }
    ...
    #[inline]
    fn dispatch_flock(args : SyscallArgs) -> isize { sys::sys_flock(args).0 }

    #[inline]
    fn dispatch_ioctl(args : SyscallArgs) -> isize { sys::sys_ioctl(args).0 }
    ...
    #[inline]
    fn dispatch_waitid(args : SyscallArgs) -> isize { sys::sys_waitid(args).0 }
    ...
    #[inline]
    fn dispatch_setpgid(args : SyscallArgs) -> isize { sys::sys_setpgid(args).0 }

    #[inline]
    fn dispatch_getpgid(args : SyscallArgs) -> isize { sys::sys_getpgid(args).0 }

    #[inline]
    fn dispatch_setpriority(args : SyscallArgs) -> isize { sys::sys_setpriority(args).0 }

    #[inline]
    fn dispatch_getpriority(args : SyscallArgs) -> isize { sys::sys_getpriority(args).0 }
    ...
    #[inline]
    fn dispatch_symlinkat(args : SyscallArgs) -> isize { sys::sys_symlinkat(args).0 }
    ...
    #[inline]
    fn dispatch_renameat2(args : SyscallArgs) -> isize { sys::sys_renameat2(args).0 }

    #[inline]
    fn dispatch_renameat(args : SyscallArgs) -> isize { sys::sys_renameat(args).0 }

    #[inline]
    fn dispatch_utimensat(args : SyscallArgs) -> isize { sys::sys_utimensat(args).0 }
    ...
    #[inline]
    fn dispatch_unshare(args : SyscallArgs) -> isize { sys::sys_unshare(args).0 }

    #[inline]
    fn dispatch_uname(args : SyscallArgs) -> isize { sys::sys_uname(args).0 }

    #[inline]
    fn dispatch_syslog(args : SyscallArgs) -> isize { sys::sys_syslog(args).0 }

    #[inline]
    fn dispatch_prctl(args : SyscallArgs) -> isize { sys::sys_prctl(args).0 }

    #[inline]
    fn dispatch_capget(args : SyscallArgs) -> isize { sys::sys_capget(args).0 }

    #[inline]
    fn dispatch_capset(args : SyscallArgs) -> isize { sys::sys_capset(args).0 }

    #[inline]
    fn dispatch_getrlimit(args : SyscallArgs) -> isize { sys::sys_getrlimit(args).0 }

    #[inline]
    fn dispatch_getrusage(args : SyscallArgs) -> isize { sys::sys_getrusage(args).0 }

    #[inline]
    fn dispatch_setitimer(args : SyscallArgs) -> isize { sys::sys_setitimer(args).0 }

    #[inline]
    fn dispatch_getitimer(args : SyscallArgs) -> isize { sys::sys_getitimer(args).0 }

    #[inline]
    fn dispatch_rt_sigpending(args : SyscallArgs) -> isize { sys::sys_rt_sigpending(args).0 }

    #[inline]
    fn dispatch_rt_sigsuspend(args : SyscallArgs) -> isize { sys::sys_rt_sigsuspend(args).0 }

    #[inline]
    fn dispatch_tkill(args : SyscallArgs) -> isize { sys::sys_tkill(args).0 }

    #[inline]
    fn dispatch_tgkill(args : SyscallArgs) -> isize { sys::sys_tgkill(args).0 }

    #[inline]
    fn dispatch_setrlimit(args : SyscallArgs) -> isize { sys::sys_setrlimit(args).0 }

    #[inline]
    fn dispatch_umask(args : SyscallArgs) -> isize { sys::sys_umask(args).0 }
    ...
    #[inline]
    fn dispatch_set_robust_list(args : SyscallArgs) -> isize { sys::sys_set_robust_list(args).0 }

    #[inline]
    fn dispatch_get_robust_list(args : SyscallArgs) -> isize { sys::sys_get_robust_list(args).0 }
    ...
    #[inline]
    fn dispatch_rt_sigtimedwait(args : SyscallArgs) -> isize { sys::sys_rt_sigtimedwait(args).0 }

    #[inline]
    fn dispatch_unsupported(kind : api_v0::SyscallKind,
                            syscall_nr : usize,
                            args : SyscallArgs)
                            -> isize {
    ...
    #[inline]
    fn dispatch_socketpair(args : SyscallArgs) -> isize { sys::sys_socketpair(args).0 }
    ...
    #[inline]
    fn dispatch_accept(args : SyscallArgs) -> isize { sys::sys_accept(args).0 }
    ...
    #[inline]
    fn dispatch_ppoll(args : SyscallArgs) -> isize { sys::sys_ppoll(args).0 }

    #[inline]
    fn dispatch_pselect6(args : SyscallArgs) -> isize { sys::sys_pselect6(args).0 }

    #[inline]
    fn dispatch_select(args : SyscallArgs) -> isize { sys::sys_select(args).0 }

    #[inline]
    fn dispatch_poll(args : SyscallArgs) -> isize { sys::sys_poll(args).0 }

    #[inline]
    fn dispatch_epoll_create1(args : SyscallArgs) -> isize { sys::sys_epoll_create1(args).0 }

    #[inline]
    fn dispatch_epoll_ctl(args : SyscallArgs) -> isize { sys::sys_epoll_ctl(args).0 }

    #[inline]
    fn dispatch_epoll_wait(args : SyscallArgs) -> isize { sys::sys_epoll_wait(args).0 }

    #[inline]
    fn dispatch_epoll_pwait(args : SyscallArgs) -> isize { sys::sys_epoll_pwait(args).0 }
}
