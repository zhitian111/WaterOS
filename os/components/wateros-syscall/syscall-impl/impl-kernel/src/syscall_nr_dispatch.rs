...
pub fn dispatch_syscall_by_nr(syscall_nr : usize, syscall_args : SyscallArgs) -> isize {
    match syscall_nr {
        ...
        n if n == api_v0::VMSPLICE => sys::sys_vmsplice(syscall_args).0,
        n if n == api_v0::COPY_FILE_RANGE => sys::sys_copy_file_range(syscall_args).0,
        n if n == api_v0::FADVISE64 => sys::sys_fadvise64(syscall_args).0,
        n if n == api_v0::READAHEAD => sys::sys_readahead(syscall_args).0,
        ...
        n if n == api_v0::SYNCFS => sys::sys_syncfs(syscall_args).0,
        ...
        n if n == api_v0::MSGGET => sys::sys_msgget(syscall_args).0,
        ...
        n if n == api_v0::IOPRIO_SET => sys::sys_ioprio_set(syscall_args).0,
        n if n == api_v0::IOPRIO_GET => sys::sys_ioprio_get(syscall_args).0,
        ...
        n if n == api_v0::PERSONALITY => sys::sys_personality(syscall_args).0,
        n if n == api_v0::SETHOSTNAME => sys::sys_sethostname(syscall_args).0,
        n if n == api_v0::SETDOMAINNAME => sys::sys_setdomainname(syscall_args).0,
        n if n == api_v0::REBOOT => sys::sys_reboot(syscall_args).0,
        ...
        n if n == api_v0::CHROOT => sys::sys_chroot(syscall_args).0,
