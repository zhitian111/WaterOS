...
use super::socket::{
    listen_endpoint, next_ephemeral_port, socket_finish_recv, socket_prepare_recv,
};
use super::state::{
...
pub fn socket_recvfrom(handle : SocketHandle,
    ...
    match socket_finish_recv(reservation, copied, true).map_err(map_recv_error)? {
        super::types::SocketRecvFinish::Bytes(n) => Ok((n, ip, port)),
        super::types::SocketRecvFinish::Fault => Err(NetworkError::Io),
    }
}

fn map_recv_error(error : super::types::SocketRecvError) -> NetworkError {
    match error {
        super::types::SocketRecvError::InvalidSocket => NetworkError::InvalidSocket,
        super::types::SocketRecvError::Busy |
        super::types::SocketRecvError::Empty |
        super::types::SocketRecvError::Finished => NetworkError::InvalidState,
        super::types::SocketRecvError::NoMemory => NetworkError::Internal,
        super::types::SocketRecvError::Io => NetworkError::Io,
    }
}
