...
pub use socket::{
    socket_bind, socket_close, socket_connect, socket_kind, socket_local_endpoint,
    socket_local_port, socket_may_send, socket_peer_endpoint, socket_peer_is_loopback,
    socket_peername, socket_poll_snapshot, socket_recv, socket_send, socket_send_capacity,
    socket_shutdown, socket_state,
};
