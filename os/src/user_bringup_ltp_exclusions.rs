...
/// 源：Read 判读 + rv_local_run_all 手工增补；共 2020 条。
/// 2026-08-15：按线下赛可用性移除两批测例使其进入测试集参与评分：
///  ① 243 条基础 syscall 测例（chmod/chown/fcntl/fork/mmap/mprotect/mremap/
///     statx/sendfile/setuid 族等，对应 syscall 已在 run.log 验证）；
