...
用法：
  # 首次：复制并编辑配置
  cp os/scripts/educg_cookie.conf.example os/scripts/educg_cookie.conf

  # 推送 cookie（从浏览器 DevTools 复制 educg_session 值）
  python3 os/scripts/educg_update_cookie.py --session 'A028F4BC...'

  # 交互输入（不回显）
  python3 os/scripts/educg_update_cookie.py

  # 查看服务器状态
  python3 os/scripts/educg_update_cookie.py --status
"""
