...
#
# 用法（在 os/ 目录）:
#   ./scripts/ltp_prune_sdcard_before.sh
#   ./scripts/ltp_prune_sdcard_before.sh --before mmapstress01
#   ./scripts/ltp_prune_sdcard_before.sh --img sdcard-la.img --before open01 --libc glibc
#   ./scripts/ltp_prune_sdcard_before.sh --dry-run --before mmapstress01
#   ./scripts/ltp_prune_sdcard_before.sh --reset-from ../test_case/sdcard-la.img --before mmapstress01
#
# 选项:
