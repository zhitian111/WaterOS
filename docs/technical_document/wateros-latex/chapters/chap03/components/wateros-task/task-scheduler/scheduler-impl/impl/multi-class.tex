...
\code{MultiClassScheduler}组合\code{TaskRegistry}、\code{WaitQueues}、\code{OtherReadyQueue}，对应 \code{SCHED\_OTHER}、\code{RtFifoRunQueue}，对应 \code{SCHED\_FIFO}、\code{RtRrRunQueue}，对应 \code{SCHED\_RR}。
