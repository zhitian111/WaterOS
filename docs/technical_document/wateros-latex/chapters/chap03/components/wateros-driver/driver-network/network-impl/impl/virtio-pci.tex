...
\paragraph{启用与探测。}由\code{impl-qemu-loongarch64-virt}打开。平台\code{pci::probe\_virtio\_net\_pci}在ECAM bus0枚举\code{virtio\_device\_type==Network}的首个功能，使用\code{VirtioNetPciBarAllocator}，与块侧BAR分配器同构编程BAR后构造\code{VirtioPciNetDevice}。
