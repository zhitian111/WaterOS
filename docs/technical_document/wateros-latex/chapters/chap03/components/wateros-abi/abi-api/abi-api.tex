...
子crate\code{abi-api/api-v0}，即包名 \code{wateros-abi-api-v0}，提供四组模块：\code{errno}、\code{user\_ret}、\code{syscall\_number}、\code{syscall\_args}。聚合层在\code{api-v0} feature下按同名子模块再导出，便于\code{use abi::errno::ErrNo}等统一引用。
