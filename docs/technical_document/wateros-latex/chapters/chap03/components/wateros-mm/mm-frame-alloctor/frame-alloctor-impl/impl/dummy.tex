...
任何依赖真实物理帧的路径，页表映射、COW、惰性缺页须在 Cargo feature 中启用\code{impl-stack}。与\code{impl-stack}切换时，\code{frame-alloctor}聚合\code{lib.rs}通过\code{cfg(feature = "impl-stack")}选择再导出目标。
