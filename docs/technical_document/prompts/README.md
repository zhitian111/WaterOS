...
- `docs/agents/prompts/general.md`
- `docs/agents/prompts/structure.md`
- `docs/agents/prompts/documentation.md`
...
- 事实以当前仓库源码为准；与 `docs/technical_document/test.tex` 冲突时更新 LaTeX
