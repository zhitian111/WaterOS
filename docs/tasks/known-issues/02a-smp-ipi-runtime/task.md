...
- `docs/tasks/known-issues/02-smp-loongarch-validation/task.md`
...
交付 `docs/tasks/history/known-issues/k02a-YYYYMMDD.md`。
...
[`results/k02a-signal-return-20260805.md`](./history/k02a-signal-return-20260805.md)。

后续 GDB 双快照已补齐 IPI clear 和逐核 timer/idle 证据，详见
[`results/k02a-ipi-timer-20260805.md`](./history/k02a-ipi-timer-20260805.md)。最终双架构
各完成 1,000 次跨 CPU fork/COW/exec，父子私有页隔离且 exec 后新地址空间正常执行。
K-02A 验收项已全部完成，可以归档。

阶段报告：[`results/k02a-20260805.md`](./history/k02a-20260805.md)、
[`results/k02a-getcpu-20260805.md`](./history/k02a-getcpu-20260805.md)、
[`results/k02a-loongarch-tlb-20260805.md`](./history/k02a-loongarch-tlb-20260805.md)、
[`results/k02a-ipi-timer-20260805.md`](./history/k02a-ipi-timer-20260805.md)、
[`results/k02a-forkexec-20260805.md`](./history/k02a-forkexec-20260805.md)、
[`results/k02a-signal-return-20260805.md`](./history/k02a-signal-return-20260805.md)。
