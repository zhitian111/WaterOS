...
- [`K-02A：双架构 8 核与 IPI`](../02a-smp-ipi-runtime/task.md)
- [`K-02B：LoongArch-musl LTP`](../02b-loongarch-musl-ltp/task.md)
...
结果写入 `docs/tasks/history/known-issues/k02-YYYYMMDD.md`。缺少 LoongArch final 镜像
