...
[`results/k05d-ramfs-physical-pages-20260809.md`](./history/k05d-ramfs-physical-pages-20260809.md)。
...
结果写入 `docs/tasks/history/known-issues/k05d-YYYYMMDD.md`，包含 commit、QEMU 内存/核数、
