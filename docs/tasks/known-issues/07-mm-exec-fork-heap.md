...
- `docs/tasks/perf/wave3-fork-exit-deep-opt.md`
...
- [`K-07A：ELF lazy map`](./07a-elf-lazy-map.md)
- [`K-07B：fork/page table lifecycle`](./07b-fork-pagetable-lifecycle.md)
- [`K-07C：kernel heap backend`](./07c-kernel-heap-backend.md)
...
结果写入 `docs/tasks/known-issues/results/k07-<subtask>-YYYYMMDD.md`。无稳定收益的
策略改动不得进入最终候选。
