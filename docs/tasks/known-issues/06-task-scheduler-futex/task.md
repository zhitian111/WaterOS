...
- [`K-06A：scheduler/lat_ctx`](../06a-scheduler-ctx/task.md)
- [`K-06B：futex/waitqueue`](../06b-futex-waitqueue/task.md)
- [`K-06C：process reap`](../06c-process-reap-lifecycle/task.md)
...
每个保留子项写 `docs/tasks/history/known-issues/k06-<subtask>-YYYYMMDD.md` 并独立提交。
