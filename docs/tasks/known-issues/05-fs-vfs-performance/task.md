...
- `docs/tasks/perf/wave2-fs-read-path/task.md`
...
- [`K-05A：稳定 inode 与 dcache`](../05a-inode-dentry-cache/task.md)
- [`K-05B：page-cache O(1) LRU`](../05b-page-cache-lru/task.md)
- [`K-05C：I/O 合并与预取`](../05c-io-merge-prefetch/task.md)
- [`K-05D：ramfs 物理页后端`](../05d-ramfs-physical-pages/task.md)
...
结果写入 `docs/tasks/history/known-issues/k05-<subtask>-YYYYMMDD.md`；不要把多个性能
子项合成一个无法消融的提交。
