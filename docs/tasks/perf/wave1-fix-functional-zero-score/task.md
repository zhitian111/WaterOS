...
- `docs/prompts/tasks/analyze_kernel_log.md`（读日志定位）
- `docs/prompts/tasks/run_testsuits_qemu.md`（P2 busybox、P3 lmbench）
...
- 参考 `docs/prompts/tasks/analyze_kernel_log.md` errno 表
...
```
@docs/tasks/perf/wave1-fix-functional-zero-score/task.md
